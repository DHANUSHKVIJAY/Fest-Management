        ...
        <table> 
            ...
            <?php   
                ...
                { 
                 ...
                 echo "<td><a href='updatejudge.php?id=".$rows['JudgeId']."' title='Edit' class='btn'><i class='fa fa-edit'></i></a><a href='deletejudge.php?id=".$rows['JudgeId']."' title='Delete' class='btn'><i class='fa fa-trash'></i></a></td>"; 
             echo "<tr>"; 
                }
