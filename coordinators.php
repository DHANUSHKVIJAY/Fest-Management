...
$sql = "SELECT * FROM CoOrdinator c JOIN Department d ON c.DeptId=d.DeptId; "; 
    ...
    <section> 
        ...
        <table> 
            ...
            echo "<tr>";
                ...
                echo "<td>".$rows['CodId']."</td>"; 
                echo "<td>".$rows['CodName']."</td>";
                echo "<td>".$rows['CodMobile']."</td>";
                echo "<td>".$rows['DeptName']."</td>";
                echo "<td><a href='updatecoordinator.php?id=".$rows['CodId']."' title='Edit' class='btn'><i class='fa fa-edit'></i></a><a href='deletecoordinator.php?id=".$rows['CodId']."' title='Delete' class='btn'><i class='fa fa-trash'></i></a></td>"; 
            echo "<tr>" ;
                }
